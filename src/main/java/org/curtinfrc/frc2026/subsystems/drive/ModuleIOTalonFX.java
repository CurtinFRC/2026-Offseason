...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  // Current limits. Declared here rather than in TunerConstants because that file is generated by
  // Tuner X -- regenerating it would silently revert tuned limits. Values set here also override
  // whatever the generated initial configs supply, so these are authoritative.
  ...
  public ModuleIOTalonFX(
    ...
    // Set current limits explicitly: this config is built fresh rather than seeded from
    // constants.SteerMotorInitialConfigs, so the limits in TunerConstants never reach the steer
    // motors. Without these lines they run on Phoenix defaults with stator limiting disabled.

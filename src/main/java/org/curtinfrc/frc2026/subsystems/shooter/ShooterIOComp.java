...
public class ShooterIOComp implements ShooterIO {
  public static final int ID1 = 0; // BL Shooter
  public static final int ID2 = 0; // BR Shooter
  public static final int ID3 = 0; // FL Shooter
  public static final int ID4 = 0; // FR Shooter
  ...
  public static double convertVelocityToRPS(double velocity) {
    return velocity / (Shooter.ROLLER_DIAMETER * Math.PI);
  }

  public static double convertRPSToVelocity(double angularVelocityRotationsPerSecond) {
    return angularVelocityRotationsPerSecond * (Shooter.ROLLER_DIAMETER * Math.PI);
  }
}
